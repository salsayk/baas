-- Add/update translation for "Manage users" on Service Offices screen
-- Run: node database/run-sql.mjs database/Translations/add-service-offices-manage-users-translation.sql
