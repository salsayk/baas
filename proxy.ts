...
export async function proxy(request: NextRequest) {
  ...
  if (authSecret) {
    try {
      ...
      console.warn("Token validation failed in proxy");
    }
  }
  ...
  const protectedPaths = ['/dashboards', '/accounts', '/service-offices', '/customers', '/subcontractors', '/service-office-users', '/projects', '/contracts', '/user-contract-fee', '/subscriptions-offers', '/system-lookups', '/languages', '/language-labels', '/screens', '/playground', '/use-cases', '/billing', '/settings', '/protected'];
